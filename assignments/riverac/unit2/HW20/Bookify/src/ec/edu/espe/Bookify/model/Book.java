...
public class Book {
    ...
    public Book(String el_gran_Gatsby, String string, String ficcition_western, String f_Scott_Fitzgerald, String string0, String milano, int i, int i0, int i1, boolean b) {
